...
public class MainActivity extends Activity
    ...
    public static class LearningFragment extends Fragment {
        ...
        private static final ExerciseProvider exerciseProvider = new ExerciseProvider();
        private static Exercise exercise = exerciseProvider.getNextExercise();
        ...
        private static ArrayList<String> answersString = new ArrayList<String>(
                Arrays.asList(exercise.getRelatedWordSensesDefinitions()));
        ...
        public void updateView(View view) {
            ...
            word.setText(exercise.getWordSense().getWord());
            ListView answersListView = (ListView) view.findViewById(R.id.exercise_answers);
            answersString.clear();
            for (String newAnswer : exercise.getRelatedWordSensesDefinitions()) {
